<?php
	...
	$crsitems[0] = "Adalbert Zajadacz GmbH & Co. KG";
	...
	$crsRefID = 2275; //Kurs: Adalbert Zajadacz GmbH & Co. KG
...
//	if (!in_array(2, $rbacreview->assignedRoles($_SESSION["_authsession_user_id"]))) { //2-> Rolle Administrator
	...
	$tpl = new ilTemplate("./addons/templates/tpl.zaja-crsadmin.html", true, true);
